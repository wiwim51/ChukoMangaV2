...
const CharacterManager = require('../exempleManager/CharacterManager')
const GenreManager = require('./GenreManager')
const HouseManager = require('../exempleManager/HouseManager')
const ItemManager = require('../exempleManager/ItemManager')
const ProductImageManager = require('./ProductImageManager')
const ProductManager = require('./ProductManager')
const PurchaseManager = require('./PurchaseManager')
const RequestManager = require('./RequestManager')
const SellerproManager = require('./SellerproManager')
const SerieManager = require('./SerieManager')
const TomeManager = require('./TomeManager')
...
models.product_image = new ProductImageManager()
models.product_image.setDatabase(pool)
models.purchase = new PurchaseManager()
models.purchase.setDatabase(pool)
models.request = new RequestManager()
models.request.setDatabase(pool)
models.sellerpro = new SellerproManager()
models.sellerpro.setDatabase(pool)
models.serie = new SerieManager()
models.serie.setDatabase(pool)
models.tome = new TomeManager()
models.tome.setDatabase(pool)
